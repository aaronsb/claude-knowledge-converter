...
if [ ! -f "input/conversations.json" ]; then
    ...
    echo -e "\033[1;31m❌ ERROR: ChatGPT conversations.json not found in input/ directory!\033[0m"
    echo -e "\033[1;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
    echo ""
...
echo -e "\033[1;33m⚠️  IMPORTANT: Move your vault to a permanent location!\033[0m"
echo ""
echo "The output folder is currently in a temporary location within this git repo."
echo -e "To use with Obsidian, \033[1mmove or copy\033[0m the entire folder to where you keep"
echo "your Obsidian vaults, for example:"
echo ""
echo -e "  \033[1;36mmv output/$OUTPUT_DIR ~/Documents/ObsidianVaults/\033[0m"
echo ""
echo "Then open Obsidian and select 'Open folder as vault' with the moved folder."
echo -e "\033[1;33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo ""
